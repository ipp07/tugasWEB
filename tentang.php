		...
		<div class="wrapper">
			...
			<section class="courses">
				<article>
					...
					<hgroup>
						<h2>Tentang Web Kuliner Jogja</h2>
					</hgroup>
					<p>
				Web ini dibuat untuk memberikan informasi mengenai beberapa tempat rekomendasi wisata kuliner di daerah seputaran Jogja. Bagi kalian yang belum tahu banyak menenai tempat, harga, lokasi dan makanan yang juara di daerah Jogjakarta dan swkitarnya silahkan lihat beberapa postingan rekomendasi kuliner Jogja yang telah disediakan .
				</p>
				</article>
			</section>
			<aside>
